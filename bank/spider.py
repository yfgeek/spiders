...
class Spider(object):
    ...
    def baidusearch(self,word,page):
        ...
        for t in td:
            ...
            if url.endswith('.com/') or url.endswith('.cn/') or url.endswith('.com') or url.endswith('.cn') or url.endswith('.org/') or url.endswith('.org'):
...
if __name__=="__main__":
    ...
    for x in range(1,200):
        obj_spider.baidusearch('inurl:open. 开放银行', x)
        time.sleep(3)
